...
export default function QuizMainScreen() {
  ...
  const incredibleProgress = useSelector(
    state => state.quiz.progress.incredible,
  );
  ...
  return (
    <View style={styles.flex1}>
      ...
      />
      <LinearGradient colors={['#00000000', '#00000000']} style={styles.flex1}>
          ...
          <View style={styles.backgroundImage} resizeMode="cover">
            <View style={styles.container}>
              ...
              <TouchableOpacity
                style={[
                  styles.quizBlock,
                  easyProgress.completed && styles.disabledQuizBlock,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.quizBlock,
                  hardProgress.completed && styles.disabledQuizBlock,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.quizBlock,
                  incredibleProgress.completed && styles.disabledQuizBlock,
                ]}
